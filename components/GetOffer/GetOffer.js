    ...
    <div className=" my-12">
      <div className={Styles.GetOfferContainer}>
        <div className=" py-28 text-center">
          <h1 className=" text-2xl lg:text-5xl font-semibold mb-2 text-white">Stay Informed About Special Offers</h1>
          <p className=" text-md lg:text-2xl text-white mb-8">For Exclusive Deals, Coupons, News and More!</p>
